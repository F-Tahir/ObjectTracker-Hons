# Given a yml file, and a vicon csv file relating to that yml file, this script loops through each frame block
# in the yml file, and finds the best matching row in the csv file. The data is then appended into a new yml file,
# giving a file with complete data from both the phone and vicon system.
...
optparser.add_option("-n", "--newfile", dest="dest", default="rec1processed.yml", \
                     help="Location of file to write data to.")
optparser.add_option("-t", "--threshold", dest="threshold", default=0.01, type="int", \
                     help="Location of file to write data to.")
